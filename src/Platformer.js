...
Engine.Platformer = function() {
    Engine.TileLayer = Engine.Sprite.extend({
        ...
        load: function( dataAsset ) {
            ...
            this.properties.width = this.properties.rows * this.properties.tileH * this.properties.scale;
            this.properties.height = this.properties.cols * this.properties.tileW * this.properties.scale;
        },
